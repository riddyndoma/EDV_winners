...
current_clean_relationships <- get_latest_data("^relationships.*.rds", clean_folder)
current_clean_complete_followed_prep <- get_latest_data("^complete_followed.*.rds", clean_folder)
...
current_clean_relationships <- rio::import(current_clean_relationships) %>%
  as_tibble()

current_clean_complete_followed_prep
current_clean_complete_followed_prep <- rio::import(current_clean_complete_followed_prep) %>%
  as_tibble()
...
fig <- ggplot2::ggplot(data = people_clin_weekly)+geom_line(aes(x=semaine,y=n,colour = eval, group=eval),size=2)
fig <- fig + theme(legend.position="bottom", legend.direction="horizontal", legend.title = element_blank())
...
#### >
```{r eval-psycho_eval, fig.height=7,fig.width=19,fig.align='center'}
#---------------------------Eval chart------------------------------------------
tristesse_followed_current_week=getPsychoEvaluationByElem(dfw_30days_followups,current_week,"tris")
tristesse_followed_1week_ago=getPsychoEvaluationByElem(dfw_30days_followups,current_week-1,"tris")
tristesse_followed_2weeks_ago=getPsychoEvaluationByElem(dfw_30days_followups,current_week-2,"tris")
...
fig <- ggplot2::ggplot(data = people_psycho_weekly)+geom_line(aes(x=semaine,y=n,colour = eval, group=eval),size=3)
fig <- fig + theme(legend.position="bottom", legend.direction="horizontal", legend.title = element_blank())
fig <- fig + theme_classic()+labs(x="",y="Nombre de gueris", title = "Guéris suivis par semaine, selon l'évaluation psycho", subtitle = )
fig <- fig + scale_colour_manual(values=colour)
...
### Test
```{r rest , fig.height=5,fig.width=19,fig.align='center'}
library(plotly)

#   rand_people <- people_regularity %>%
#     mutate(presence=v,
#            mois=month_val,
#            id=i)
# fig <- plot_ly(z = rand_people,type = "heatmap")
# fig
...
### Gueris suivis par mois, selon le sexe

```{r survivors-followed-weekly, fig.width=9,fig.align='center',fig.height=3.3}
men_followed_may2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-05","m")
men_followed_avril2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-04","m")
men_followed_mars2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-03","m")
men_followed_fev2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-02","m")
men_followed_janv2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-01","m")
men_followed_dec2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-12","m")
men_followed_nov2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-11","m")
men_followed_oct2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-10","m")
men_followed_sept2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-09","m")
men_followed_aout2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-08","m")
men_followed_juil2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-07","m")

men_followed_monthly=rbind(men_followed_may2021,men_followed_avril2021,men_followed_mars2021,men_followed_fev2021,
men_followed_janv2021,men_followed_dec2020,men_followed_nov2020,men_followed_oct2020,
men_followed_sept2020,men_followed_aout2020,men_followed_juil2020)
setDT(men_followed_monthly, keep.rownames = "mois") #Convert rowname to first column
men_followed_monthly=men_followed_monthly%>%
  mutate(sexe="Homme")

#-----------------------------------------------------------------------
women_followed_may2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-05","f")
women_followed_avril2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-04","f")
women_followed_mars2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-03","f")
women_followed_fev2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-02","f")
women_followed_janv2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-01","f")
women_followed_dec2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-12","f")
women_followed_nov2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-11","f")
women_followed_oct2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-10","f")
women_followed_sept2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-09","f")
women_followed_aout2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-08","f")
women_followed_juil2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-07","f")

women_followed_monthly=rbind(women_followed_may2021,women_followed_avril2021,women_followed_mars2021,women_followed_fev2021,
women_followed_janv2021,women_followed_dec2020,women_followed_nov2020,women_followed_oct2020,
women_followed_sept2020,women_followed_aout2020,women_followed_juil2020)
setDT(women_followed_monthly, keep.rownames = "mois") #Convert rowname to first column
women_followed_monthly=women_followed_monthly%>%
  mutate(sexe="Femme")

#------------------------------------------------------------------------
all_followed_may2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-05","")
all_followed_avril2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-04","")
all_followed_mars2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-03","")
all_followed_fev2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-02","")
all_followed_janv2021=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2021-01","")
all_followed_dec2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-12","")
all_followed_nov2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-11","")
all_followed_oct2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-10","")
all_followed_sept2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-09","")
all_followed_aout2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-08","")
all_followed_juil2020=getFollowedPeopleByMonths(current_clean_complete_followed_prep,"2020-07","")

all_followed_monthly=rbind(all_followed_may2021,all_followed_avril2021,all_followed_mars2021,all_followed_fev2021,
all_followed_janv2021,all_followed_dec2020,all_followed_nov2020,all_followed_oct2020,
all_followed_sept2020,all_followed_aout2020,all_followed_juil2020)
setDT(all_followed_monthly, keep.rownames = "mois") #Convert rowname to first column
all_followed_monthly=all_followed_monthly%>%
  mutate(sexe="ensemble")

#-----------------------------------------------------------------------

people_seen_monthly=rbind(all_followed_monthly,men_followed_monthly,women_followed_monthly) %>%
  arrange(mois)

colour <-c("#ec524b","#9ad3bc","#f5b461")

fig <- ggplot2::ggplot(data = people_seen_monthly)+geom_line(aes(x=mois,y=n,colour = sexe, group=sexe),size=1)
fig <- fig + theme(legend.position="bottom", legend.direction="horizontal", legend.title = element_blank())
fig <- fig + theme_classic()+labs(x="",y="Nombre de gueris", title = "Evolution du nombre de guéris suivis mensuellement, selon le sexe", subtitle = )
fig <- fig + scale_colour_manual(values=colour)
...
### Catégorisation des guéris selon les dates de sortie CTE

```{r winners-out-cte, fig.height=3.5,fig.align='center'}

library("lubridate")

current_clean_cases$sexe <- ifelse(is.na(current_clean_cases$sexe), current_clean_cases$gender, current_clean_cases$sexe)
df_cases <- current_clean_cases %>%
   mutate(sexe=case_when(
    tolower(sexe) =='feminin' ~ 'Femme',
    tolower(sexe) =='masculin' ~ 'Homme',
    tolower(sexe) =='femme' ~ 'Femme',
    tolower(sexe) =='homme' ~ 'Homme'
  ))%>%
  ...
  group_by(segment,sexe) %>%
  filter(!is.na(sexe)) %>%
  count()

g <- ggplot(data=df_cases, aes(x=reorder(segment, -n), y=n, fill=segment)) +
geom_bar(stat="identity")+theme_classic() +labs(x="",y="Effectifs", title = "", subtitle = )
g <- g+geom_text( aes(label = n, y = n),position = position_dodge(0.9),vjust = 0)+facet_grid(~sexe)
g <- g+scale_fill_poke(pokemon = 'Quilava', spread = 6)
g <- g+theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
g <- g+theme(legend.background = element_rect(fill="#b2c8d6",
                                  size=0.5, linetype="solid",
...
REGULARITE AU SUIVI {data-icon="fa-notes-medical"}
===========================================================================
Column {.tabset data-width=100%}
---------------------------------------------------------------------------

### Régularité (1)
```{r regularity-1, fig.height=6,fig.width=21}


df_jul20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-07")
df_aou20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-08")
df_sept20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-09")
df_oct20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-10")
df_nov20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-11")
df_dec20 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2020-12")
df_jan21 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2021-01")
df_fev21 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2021-02")
df_mar21 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2021-03")
df_avr21 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2021-04")
df_may21 <- getRegularityInFollowups(current_clean_contacts,current_clean_complete_followed_prep,"2021-05")
people_regularity=rbind(df_jul20,df_aou20,df_sept20,df_oct20,df_nov20,df_dec20,df_jan21,df_fev21,df_mar21,df_avr21,df_may21) %>%
  arrange(month_val) %>%
  distinct(month_val,v,i)

#Suppression de doublon
df_visualid <- people_regularity %>%
  select(id=i) %>%
  distinct()

parts_list <- split(df_visualid, (seq(nrow(df_visualid))-1) %/% 68) # Devivier le ID en sous df de 68 lignes
 
people_regularity <- people_regularity %>%
    mutate(presence=v,
           mois=month_val,
           id=i) %>%
    select(mois,id,presence)  

part1_id <- parts_list[[1]]
part2_id <- parts_list[[2]]
part3_id <- parts_list[[3]]
part4_id <- parts_list[[4]]
part5_id <- parts_list[[5]]
part6_id <- parts_list[[6]]
part7_id <- parts_list[[7]]
part8_id <- parts_list[[8]]
part9_id <- parts_list[[9]]
part10_id <- parts_list[[10]]
part11_id <- parts_list[[11]]
part12_id <- parts_list[[12]]
part13_id <- parts_list[[13]]
part14_id <- parts_list[[14]]
part15_id <- parts_list[[15]]
part16_id <- parts_list[[16]]

part1 <- people_regularity %>%
  filter( id %in% part1_id$id)

fig <- ggplot(data = part1, aes(x=id, y=mois, fill=presence)) + 
...
### Régularité (2)
```{r regularity-2, fig.height=6,fig.width=21}

part2 <- people_regularity %>%
  filter( id %in% part2_id$id)
     
fig <- ggplot(data = part2, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (3)
```{r regularity-3, fig.height=6,fig.width=21}

part3 <- people_regularity %>%
  filter( id %in% part3_id$id)
     
fig <- ggplot(data = part3, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (4)
```{r regularity-4, fig.height=6,fig.width=21}

part4 <- people_regularity %>%
  filter( id %in% part4_id$id)
     
fig <- ggplot(data = part4, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (5)
```{r regularity-5, fig.height=6,fig.width=21}

part5 <- people_regularity %>%
  filter( id %in% part5_id$id)
     
fig <- ggplot(data = part5, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (6)
```{r regularity-6, fig.height=6,fig.width=21}

part6 <- people_regularity %>%
  filter( id %in% part6_id$id)
     
fig <- ggplot(data = part6, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (7)
```{r regularity-7, fig.height=6,fig.width=21}

part7 <- people_regularity %>%
  filter( id %in% part7_id$id)
     
fig <- ggplot(data = part7, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (8)
```{r regularity-8, fig.height=6,fig.width=21}

part8 <- people_regularity %>%
  filter( id %in% part8_id$id)
     
fig <- ggplot(data = part8, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (9)
```{r regularity-9, fig.height=6,fig.width=21}

part9 <- people_regularity %>%
  filter( id %in% part9_id$id)
     
fig <- ggplot(data = part9, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (10)
```{r regularity-10, fig.height=6,fig.width=21}

part10 <- people_regularity %>%
  filter( id %in% part10_id$id)
     
fig <- ggplot(data = part10, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (11)
```{r regularity-11, fig.height=6,fig.width=21}

part11 <- people_regularity %>%
  filter( id %in% part11_id$id)
     
fig <- ggplot(data = part11, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (12)
```{r regularity-12, fig.height=6,fig.width=21}

part12 <- people_regularity %>%
  filter( id %in% part12_id$id)
     
fig <- ggplot(data = part12, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (13)
```{r regularity-13, fig.height=6,fig.width=21}

part13 <- people_regularity %>%
  filter( id %in% part13_id$id)
     
fig <- ggplot(data = part13, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (14)
```{r regularity-14, fig.height=6,fig.width=21}

part14 <- people_regularity %>%
  filter( id %in% part14_id$id)
     
fig <- ggplot(data = part14, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (15)
```{r regularity-15, fig.height=6,fig.width=21}

part15 <- people_regularity %>%
  filter( id %in% part15_id$id)
     
fig <- ggplot(data = part15, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
...
### Régularité (16)
```{r regularity-16, fig.height=6,fig.width=21}

part16 <- people_regularity %>%
  filter( id %in% part16_id$id)
     
fig <- ggplot(data = part16, aes(x=id, y=mois, fill=presence)) + 
  geom_tile() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
